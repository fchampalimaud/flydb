...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('research', '0007_migrate_position_data_from_person_to_groupmember'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lab', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='research.Group', verbose_name='Ownership')),
